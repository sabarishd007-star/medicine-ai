...
def main():
    ...
    # Class weights: glioma recall was only 37% because it was confused with
    # meningioma and no-tumor. Up-weight glioma so the optimizer penalises
    # missing it ~3x more than the easy classes. After re-evaluation this can be
    # dialled back once recall balances out.
    class_counts = {}
    ...
    # Normalise so the average weight is 1.0 — keeps the learning rate sane.
